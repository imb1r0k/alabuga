...
export const DashboardPage = () => {
      ...
      <div className="container" style={{ paddingTop: '40px' }}>
        <div className="card" style={{ minHeight: '300px' }}>
          <div style={{ padding: '24px' }}>
            <h1 style={{ fontSize: '28px', marginBottom: '24px', color: '#333', visibility: 'hidden' }}>Личный кабинет</h1>
            ...
            <div style={{ borderTop: '1px solid #eee', marginTop: '24px', paddingTop: '24px', visibility: 'hidden' }}>
              <h3 style={{ marginBottom: '12px', color: '#333', visibility: 'hidden' }}>Ваша информация</h3>
              <p style={{ color: '#666', visibility: 'hidden' }}>Здесь будет отображаться информация о вашем аккаунте и активности.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="container" style={{ paddingTop: '40px' }}>
      <div className="card">
        <h1 style={{ fontSize: '28px', marginBottom: '24px', color: '#333' }}>Личный кабинет</h1>
        <div style={{ borderTop: '1px solid #eee', paddingTop: '24px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <p style={{ fontSize: '18px', color: '#333' }}>{user?.username || 'Не указан'}</p>
          </div>
          <div>
        ...
        <div style={{ borderTop: '1px solid #eee', marginTop: '24px', paddingTop: '24px' }}>
          ...
          <p style={{ color: '#666' }}>Здесь будет отображаться информация о вашем аккаунте и активности.</p>
        </div>
      </div>
    </div>
  );
