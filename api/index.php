...
// =============================================================================
// Точка входа PHP API.
// Выполняет соединение с БД, общие подготовительные операции и подключает
// маршруты из папки modules/ по разделам функционала.
// =============================================================================
...
try {
    ...
    require_once __DIR__ . '/modules/auth.php';                 // авторизация
    require_once __DIR__ . '/modules/bookings.php';            // бронирование
    require_once __DIR__ . '/modules/auto_book.php';           // автоподбор комнаты
    require_once __DIR__ . '/modules/profile_teams.php';       // профиль и команды
    require_once __DIR__ . '/modules/settings.php';            // настройки и уведомления
    require_once __DIR__ . '/modules/admin_stats.php';         // статистика, экспорт, архивы
