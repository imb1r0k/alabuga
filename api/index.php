...
try {
    ...
    if ($uri === 'public/layout') {
        ...
        // Готовим запрос получения списка проживающих для комнат
    ...
    // Обработка остальных стандартных эндпоинтов (export, archive, settings и т.д.)
...
<dyad-write path="src/pages/admin/AdminUsersPage.tsx" description="Обновление таблицы управления пользователями с добавлением колонок Рейтинг и Выполненные задания">
...
import { QrCode, X, Shield, CheckSquare, Square, Search, Filter, RotateCcw, Award, CheckCircle2 } from 'lucide-react';
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '14px' }}>
                <thead>
                  <tr style={{ backgroundColor: '#f8f9fa', borderBottom: '2px solid #ddd' }}>
                    ...
                    <th style={{ padding: '10px' }}>Задания</th>
                        ...
                        >
                          ...
                          <td style={{ padding: '10px' }}>
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontWeight: 700, color: '#d97706' }}>
                              <Award size={14} /> {u.rating || 0}
                            </span>
                          </td>
                          <td style={{ padding: '10px' }}>
                            <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontWeight: 600, color: '#0284c7' }}>
                              <CheckCircle2 size={14} /> {u.completed_tasks || 0}
                            </span>
                          </td>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <form onSubmit={handleSaveUser} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px' }}>
                    ...
                    <div className="input-group">
                      <label>Выполненные задания (шт.)</label>
                      <input
                        type="number"
                        min={0}
                        value={userFormData.completed_tasks}
                        onChange={(e) => setUserFormData({ ...userFormData, completed_tasks: Number(e.target.value) })}
                      />
                    </div>
